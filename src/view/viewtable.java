...
public class viewtable extends javax.swing.JFrame {
    ...
    public ArrayList<Customer> customerList(){
        ...
        try{
            ...
            while(rs.next()){
                customer = new Customer(rs.getString("invoiceid"),rs.getDouble("amount"),rs.getString("postcode"),rs.getString("address"));
    ...
    public void showcustomer(){
        ...
        for(int i = 0; i < list.size(); i++){
            if(list.get(i).getPostcode().equals("52100")){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice ID", "Amount", "Postcode", "Address"
            }
        ));
